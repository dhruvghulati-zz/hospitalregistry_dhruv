...
public class HospitalGuiFinal {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					HospitalGuiFinal window = new HospitalGuiFinal();
...
//		cardPanel.add(registryCard, "Registration Panel");
